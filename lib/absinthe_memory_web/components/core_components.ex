defmodule AbsintheMemoryWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AbsintheMemoryWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AbsintheMemoryWeb.Gettext, "errors", msg, opts)
    end
  end
